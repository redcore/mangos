...
struct MANGOS_DLL_DECL boss_gortokAI : public ScriptedAI
{
	...
	void UpdateAI(const uint32 uiDiff)
    {
        ...
        {
            DoCast(m_creature, m_bIsHeroicMode ? SPELL_WITHERING_ROAR_H : SPELL_WITHERING_ROAR_N);
        ...
        {
            DoCast(SelectUnit(SELECT_TARGET_RANDOM, 0), m_bIsHeroicMode ? SPELL_IMPALE_H : SPELL_IMPALE_N);
...
struct MANGOS_DLL_DECL mob_massive_jormungarAI : public ScriptedAI
{
    ...
    void UpdateAI(const uint32 uiDiff)
    {
        ...
        {
            DoCast(m_creature, m_bIsHeroicMode ? SPELL_ACID_SPLATTER_H : SPELL_ACID_SPLATTER_N);
        ...
        {
            DoCast(SelectUnit(SELECT_TARGET_RANDOM, 0), m_bIsHeroicMode ? SPELL_POISON_BREATH_H : SPELL_POISON_BREATH_N);
...
struct MANGOS_DLL_DECL mob_ferocious_rhinoAI : public ScriptedAI
{
    ...
    void UpdateAI(const uint32 uiDiff)
    {
        ...
        {
            DoCast(SelectUnit(SELECT_TARGET_RANDOM, 0), m_bIsHeroicMode ? SPELL_GRIEVOUS_WOUND_H : SPELL_GRIEVOUS_WOUND_N);
...
struct MANGOS_DLL_DECL mob_ravenous_furbolgAI : public ScriptedAI
{
    ...
    void UpdateAI(const uint32 uiDiff)
    {
        ...
        {
            DoCast(m_creature->getVictim(), m_bIsHeroicMode ? SPELL_CHAIN_LIGHTING_H : SPELL_CHAIN_LIGHTING_N);
...
struct MANGOS_DLL_DECL mob_frenzied_worgenAI : public ScriptedAI
{
    ...
    void UpdateAI(const uint32 uiDiff)
    {
        ...
        {
            DoCast(m_creature->getVictim(), m_bIsHeroicMode ? SPELL_MORTAL_WOUND_H : SPELL_MORTAL_WOUND_H);
